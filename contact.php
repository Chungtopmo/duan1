...
if(isset($_POST["btn_submit"]))
{
    ...
    $con = new connec();
    $con->insert($sql,"We Will Contact You Soon On Your Email");
}
            ...
            <div class="col-md-6">
                <form method="post">
                    <div class="container" style="color:maroon;">
                        ...
                        <input type="text" style="border-radius:30px;" placeholder="Enter Your Name" name="name" id="username" required>
                        ...
                        <button type="submit" name="btn_submit" class="btn" name="btn_reg" style="background-color:maroon;color:white;">Send Messenger</button>
                        <hr>
                    </div>
