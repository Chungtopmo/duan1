...
<section class="mt-5 ">
    <h3 class="text-center" style="color: maroon;">Comming Soon</h3>
    <div class="container">
        <div class="row">
            <?php
                if($result->num_rows>0)
                {
                    while($row=$result->fetch_assoc())
                    {
                        ...
                        <div class="col-md-3">
                            ...
                            <a class="btn" href="booking.php" style="background-color:maroon;color:white;width:100%;">Now Book Ticket</a>
                        </div>
                        <?php
                    }
                }
